...
2. Follow steps 2 to 4 in the "Converting a level" section. You do not have to insert information as it will automatically convert all TMX files and use the JSON5 file. The GMD files will be found in the `converted` folder.
